...
def model():
	...
	model.compile(loss='categorical_crossentropy',
	              optimizer=opt,
	              metrics=['accuracy'])
	model.load_weights('/home/fractaluser/Desktop/SpeakerRecognition/my_model_weights.h5')
...
def svm_train(svm_x_train,svm_y_train,x_test,model, dummy2_y):
...
def main():
	mod = model()
	rootdir = '/home/fractaluser/Desktop/test/voice-classification-master/audioInputs/'
	traindata = training_data(rootdir)
	x_train = traindata[0]
	y_train = traindata[1]

	rootdir1 = '/home/fractaluser/Desktop/test/voice-classification-master/audioInputs1/'
	...
	svm_train(svm_x_train,svm_y_train,x_test,mod,dum)
